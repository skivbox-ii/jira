// Основной модуль Sprint Health
define("_ujgSH_main", ["jquery", "_ujgSH_config", "_ujgSH_utils", "_ujgSH_storage", "_ujgSH_api", "_ujgSH_burndown", "_ujgSH_charts_svg", "_ujgSH_charts_canvas"], function($, config, utils, storage, api, burndown, chartsSvg, chartsCanvas) {
    "use strict";
    ...
    var isIssueDone = burndown.isIssueDone;
    var buildBurndown = burndown.buildBurndown;
    var parseScopeChangeBurndown = burndown.parseScopeChangeBurndown;
    var extractJiraStepSeries = burndown.extractJiraStepSeries;
    var renderMiniJiraStepChart = chartsSvg.renderMiniJiraStepChart;
    var buildJiraScopeSvg = chartsSvg.buildJiraScopeSvg;
    var drawBurnupCanvas = chartsCanvas.drawBurnupCanvas;
    ...
    function SprintHealthGadget(API) {
        ...
        function openChartFullscreen() {
            ...
            setTimeout(function() {
                var cvs = $canvas[0];
                drawBurnupCanvas(cvs, state.jiraScope.series, { buildMarkerLabelData: buildMarkerLabelData });
            }, 50);

            $(window).on("resize.ujgChartFs", function() {
                drawBurnupCanvas($canvas[0], state.jiraScope.series, { buildMarkerLabelData: buildMarkerLabelData });
            });
