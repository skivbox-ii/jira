...
### Задачи блока
- [ ] 0.1 Структура хранения конфигурации в localStorage
- [ ] 0.2 UI для настройки workflow (drag & drop)
- [ ] 0.3 Авто-определение статусов при первой загрузке
- [ ] 0.4 Функции-хелперы для работы с категориями
- [ ] 0.5 Fallback логика для отсутствующих категорий
...
### Задачи блока
- [ ] 1.1 Создать компонент модального окна
- [ ] 1.2 Реализовать API-трекер с подсчётом запросов
- [ ] 1.3 Добавить расчёт ETA и среднего времени
- [ ] 1.4 Обработка отмены загрузки
- [ ] 1.5 Graceful degradation при ошибках
...
### Задачи блока
- [ ] 2.1 Парсер changelog с фильтрацией по периоду
- [ ] 2.2 Визуализация timeline изменений
- [ ] 2.3 Агрегация метрик активности
...
### Задачи блока
- [ ] 3.1 Калькулятор времени в статусах (с учётом периода)
- [ ] 3.2 Калькулятор времени на исполнителях
- [ ] 3.3 Расчёт Lead/Cycle/Wait Time
- [ ] 3.4 Heatmap визуализация
...
### Задачи блока
- [ ] 4.1 Интеграция с Bitbucket/GitHub API через dev-status
- [ ] 4.2 Парсер PR и коммитов
- [ ] 4.3 Расчёт PR Cycle Time и iterations
- [ ] 4.4 Матрица "автор-ревьюер"
- [ ] 4.5 Выявление паттерна "пинг-понг"
- [ ] 4.6 First-time Approval Rate по разработчикам
...
### Задачи блока
- [ ] 5.1 Детектор очереди на Code Review
- [ ] 5.2 Детектор задач-бумерангов
- [ ] 5.3 Детектор задач-путешественников
- [ ] 5.4 Детектор "брошенных" задач
- [ ] 5.5 Детектор перегруза WIP
- [ ] 5.6 Агрегатор проблем с приоритизацией
...
### Задачи блока
- [ ] 6.1 Расчёт velocity и throughput
...
### Задачи блока
- [ ] 7.1 Калькулятор risk score
- [ ] 7.2 Конфигурация весов рисков
- [ ] 7.3 Визуализация risk matrix
