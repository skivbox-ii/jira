...
- [x] 0.6 Миграция конфигурации при добавлении новых статусов
...
### Задачи блока
- [x] 8.1 Хранение исторических данных (localStorage/IndexedDB)
- [x] 8.2 Расчёт изменений между периодами
- [x] 8.3 Визуализация трендов (стрелки, цвета)
