...
│                                                                                                     │
├─────────────────────────────────────────────────────────────────────────────────────────────────────┤
│  📋 ВСЕ ЗАДАЧИ СПРИНТА — группировка по исполнителю, в скобках суммарные часы по его задачам.      │
│  Наведение на ячейки ганнта показывает тултип с часами и комментариями по ворклогам.                │
│                                                                                                     │
│  ┌────────┬────────────────────┬──────┬───────────┬───────────┬────────┬───────────────────────────┐│
